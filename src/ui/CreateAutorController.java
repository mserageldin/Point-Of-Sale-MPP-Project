...
public class CreateAutorController {
	...
	public void setauthor(Author author) {
		this.author = author;
		Address address = this.author.getAddress();
		...
		phoneField.setText(author.getTelephone());
		bioField.setText(author.getBio());
	}
	...
	private void handleSubmit() {
		if (isInputValid()) {
			try {
				controler.addAuthor( firstNameField.getText(), lastNameField.getText(),
						streetField.getText(), cityField.getText(), stateField.getText(), zipField.getText(),
						phoneField.getText(), bioField.getText());
