...
public class DataAccessFacade implements DataAccess {
	...
	/**
	 * Save (add/update) library member information to storage
	 */
	...
	/**
	 * Store books into storage. Notice: it will override data if ISBN match exists
	 * 
	...
	public HashMap<String, Author> readAuthorMap() {
		...
		@SuppressWarnings("unchecked")
		HashMap<String, Author> readFromStorage = (HashMap<String, Author>) readFromStorage(StorageType.Authors);
